...
<header class="relative bg-green-700 text-white">
   ...
   <div class="container mx-auto px-4 py-20 md:py-32 text-center relative z-10">
      ...
      <a href="https://web.facebook.com/humch.edu.bd/" class="bg-white text-green-800 px-6 py-3 rounded-lg font-semibold hover:bg-green-100 transition inline-block">Explore the Website</a>
   </div>
