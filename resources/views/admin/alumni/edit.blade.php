            ...
            <div class="card">
                <div class="card-primary">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3 class="card-title">Edit Alumnus</h3>
                        <a href="{{ route('admin.alumni.index') }}" class="btn btn-info btn-sm">Back</a>
                    </div>
                    <form class="needs-validation" novalidate action="{{ route('admin.alumni.update', $Alumni->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <select name="institution_id" id="institution_id" class="form-control" required>
                                        ...
                                        @foreach($institutions as $inst)
                                            <option value="{{ $inst->id }}" {{ $Alumni->institution_id == $inst->id ? 'selected' : '' }}>{{ $inst->institution_name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <select name="degree_id" id="degree_id" class="form-control" required>
                                        ...
                                        @foreach($degrees as $degree)
                                            <option value="{{ $degree->id }}" {{ $Alumni->degree_id == $degree->id ? 'selected' : '' }}>{{ $degree->degree_name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <select name="program_id" id="program_id" class="form-control" required>
                                        ...
                                        @foreach($programs as $program)
                                            <option value="{{ $program->id }}" {{ $Alumni->program_id == $program->id ? 'selected' : '' }}>{{ $program->program_name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_of_student" id="name_of_student" 
                                               value="{{ old('name_of_student', $Alumni->name_of_student) }}" 
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mobile" id="mobile" 
                                               value="{{ old('mobile', $Alumni->mobile) }}" 
                                               class="form-control" required>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="passing_year" id="passing_year" 
                                               value="{{ old('passing_year', $Alumni->passing_year) }}" 
                                               class="form-control" required>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="result" id="result" 
                                               value="{{ old('result', $Alumni->result) }}" 
                                               class="form-control" required>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nationality" id="nationality" 
                                               value="{{ old('nationality', $Alumni->nationality) }}" 
                                               class="form-control" required>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="gender" id="gender" class="form-control" required>
                                            ...
                                            <option value="Others" {{ old('gender', $Alumni->gender) == 'Others' ? 'selected' : '' }}>Others</option>
                                        </select>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="marital_status" id="marital_status" class="form-control" required>
                                            ...
                                            <option value="Married" {{ old('marital_status', $Alumni->marital_status) == 'Married' ? 'selected' : '' }}>Married</option>
                                            <option value="Unmarried" {{ old('marital_status', $Alumni->marital_status) == 'Unmarried' ? 'selected' : '' }}>Unmarried</option>
                                        </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="current_occupation" id="current_occupation" class="form-control" required>{{ old('current_occupation', $Alumni->current_occupation) }}</textarea>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="current_occupation_address" id="current_occupation_address" 
                                               value="{{ old('current_occupation_address', $Alumni->current_occupation_address) }}" 
                                               class="form-control" required>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="permanent_address" id="permanent_address" class="form-control" required>{{ old('permanent_address', $Alumni->permanent_address) }}</textarea>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        @if($Alumni->student_photo)
                                            <div class="mt-2">
                                                <img src="{{ asset('storage/' . $Alumni->student_photo) }}" alt="Student Photo" width="100">
                                            </div>
                                        @endif
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control" required>
                                            <option value="on" {{ old('status', $Alumni->status) == 'on' ? 'selected' : '' }}>On</option>
                                            <option value="off" {{ old('status', $Alumni->status) == 'off' ? 'selected' : '' }}>Off</option>
                                        </select>
